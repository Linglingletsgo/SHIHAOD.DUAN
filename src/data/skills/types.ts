...
export type SkillTool = Readonly<{ id: string; name: string; label?: BilingualText; type: 'software' | 'hardware' | 'protocol' | 'platform' | 'equipment'; relatedSkillIds: readonly string[] }>;
