...
export type SkillTool = Readonly<{ id: string; name: string; label?: BilingualText; type: 'software' | 'hardware' | 'protocol' | 'platform' | 'equipment' | 'format'; relatedSkillIds: readonly string[] }>;
...
export type SkillEvidence = Readonly<{ skillId: string; experienceId?: string; linkText?: BilingualText; description: BilingualText }>;
